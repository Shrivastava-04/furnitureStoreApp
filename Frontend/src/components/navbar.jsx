          ...
          <div className="navbar-end space-x-3">
            ...
            <div className="hidden md:block">
              ...
              </label>
              {
                ...
                (<div>
              <a
                className="bg-blue-500 text-white px-3 py-2 rounded-md hover:bg-gray-200 hover:text-black dark:hover:bg-slate-800 dark:hover:text-white duration-300 cursor-pointer"
                onClick={() =>
